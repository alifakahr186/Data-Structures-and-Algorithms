...
class Graph {
  ...
  vector < Vertex > vertices;
    ...
    void BellmanFord(int source) {
        ...
        for (int iteration = 0; iteration < vertices.size() - 1; iteration++) {
            for (int j = 0; j < vertices.size(); j++) {
                for (Edge &edge : vertices[j].edgeList) {
                    int u = j;
...
int main() {
    ...
    do {
        ...
        cout << "3. Calculate Single Shortest Path Using Bellman-Ford Algorithm" << endl;
        ...
        case 3:
        cout << "Calculate Single Shortest Path Using Bellman-Ford Algorithm" << endl;
            g.BellmanFord();
            break; 
