...
class Graph {
    ...
    void BFSTraversal(int startVertexID){
      ...
      cout << "Breadth-First Search Traversal starting from Vertex " << startVertexID << ": ";
...
int main() {
    ...
    do {
      ...
      cout << "3. Get Neighbors Operation " << endl;
      cout << "4. For BFS Traversal" << endl;
      ...
      case 3:
          cout << "Breadth-First Search Traversal Operation -" << endl;
      ...
      case 4:
          ...
          cout << "Set StateID For Traversal: ";
          cin >> g.BFSTraversal(id1);
