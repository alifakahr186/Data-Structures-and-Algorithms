...
public:
    ...
    void DFS(int startVertexID, unordered_map<int, bool>& visited) {
        ...
        for (Edge& edge : currentVertex->edgeList) {
            if (!visited[edge.getDestinationVertexID()]) {
                DFS(edge.getDestinationVertexID(), visited);
            }
        }
    }
...
int main() {
    ...
    do {
        ...
        cout << "1. Add Vertex\n";
        cout << "2. Add Edge\n";
        cout << "3. Connected Components Using DFS\n";
        cout << "4. Print Graph\n";
        cout << "0. Exit Program\n";
