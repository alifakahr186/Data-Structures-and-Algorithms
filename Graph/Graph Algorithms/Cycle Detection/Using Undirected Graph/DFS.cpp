...
public:
    ...
    void DFSTraversal(int startVertexID) {
        ...
        cout << "Depth-First Search Traversal starting from Vertex " << startVertexID << ": ";

        visited[startVertexID - 1] = true;
        ...
        while (!dfsStack.empty()) {
            ...
            for (auto it = edges.begin(); it != edges.end(); it++) {
                ...
                if (!visited[neighborID - 1]) {
                    ...
                    cout << "Cycle detected between " << currentVertexID << " and " << neighborID << endl;
                }
            }
        }
...
int main() {
  ...
  do {
    ...
    case 3:
        cout << "Depth-First Search Based Cycle Detection Operation -" << endl;
        cout << "Enter ID of Starting Vertex(State): ";
        cin >> id1;
        if (g.DFSTraversal(id1)) {
